...
11. [Java Development](https://github.com/mikeroyal/AWS-Guide/blob/main/README.md#java-development)

12. [Go Development](https://github.com/mikeroyal/AWS-Guide/blob/main/README.md#go-development)

13. [Python Development](https://github.com/mikeroyal/AWS-Guide/blob/main/README.md#python-development)

14. [TypeScript Development](https://github.com/mikeroyal/AWS-Guide/blob/main/README.md#typescript-development)

15. [.NET Development](https://github.com/mikeroyal/AWS-Guide/blob/main/README.md#net-development)

16. [Ruby Development](https://github.com/mikeroyal/AWS-Guide/blob/main/README.md#ruby-development)

17. [PHP Development](https://github.com/mikeroyal/AWS-Guide/blob/main/README.md#php-development)

18. [Bash/PowerShell Development](https://github.com/mikeroyal/AWS-Guide/blob/main/README.md#bashpowershell-development)
...
[AWS IoT Core](https://console.aws.amazon.com/iot) is a tool lets you connect IoT devices to the AWS cloud without the need to provision or manage servers. AWS IoT Core can support billions of devices and trillions of messages, and can process and route t
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/AWS-Guide/pulls).
